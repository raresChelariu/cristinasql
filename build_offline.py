...
<head>
    ...
    <style>
        body {{ margin: 0; }}
        #sidebarToggle {{ margin:10px 15px 0; padding:6px 12px; border:1px solid #ccc; border-radius:4px; background:#fff; cursor:pointer; font-size:.95em; }}
        #sidebarToggle:hover {{ background:#f1f3f5; }}
        .layout {{ display:flex; gap:20px; max-width:1200px; margin:10px auto 20px; padding:0 15px; }}
        .layout.sidebar-collapsed {{ max-width:100%; }}
...
<body>
    <button id="sidebarToggle" onclick="toggleSidebar()" title="Ascunde/afiseaza meniul">&#9776; Meniu</button>
